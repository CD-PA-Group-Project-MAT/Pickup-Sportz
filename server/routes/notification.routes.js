...
module.exports = app => {
    ...
    app.get('/api/notifications/user/:userId', NotificationController.getNotificationsByUserId); // TODO add back authenticate .. will need to refactor code in Login.jsx
